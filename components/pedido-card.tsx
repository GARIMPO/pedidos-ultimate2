...
export default function PedidoCard({ pedido, onEdit, onDelete }: PedidoCardProps) {
  ...
  const abrirWhatsApp = () => {
    if (pedido.telefone) {
      ...
      let mensagem = `Olá ${pedido.nome}, seu pedido já foi enviado`

      // Adiciona o código de rastreamento se existir
      if (pedido.codigoRastreamento) {
        mensagem += ` (código de rastreio: ${pedido.codigoRastreamento})`
      }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {pedido.telefone && (
                    <Button variant="outline" size="sm" className="flex items-center gap-1" onClick={abrirWhatsApp}>
